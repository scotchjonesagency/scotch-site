...
const Navbar = () => {
  ...
  return (
    <header className="w-full flex items-center justify-between px-32 py-4 font-medium z-10 dark:text-light lg:px-16 relative md:px-12 sm:px-8">
      <Logo />
