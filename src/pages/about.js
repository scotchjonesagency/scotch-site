...
<section className="max-w-3xl mx-auto px-4">
  ...
  />
    ...
    />
    */}
    <h2 className="mb-6 text-4xl font-bold">How We&#ve Generated $12.8 Million In Revenue For Clients...</h2>
...
<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  ...
  When was the last time you looked at your competitors online and wondered how they&#re getting all those customers? How they seem to always be busy while you&#re still relying on word-of-mouth and referrals?
</p>

<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  Here&#s a shocking truth: <strong>81% of your potential customers</strong> are looking for your services online right now. But they&#re finding your competitors instead of you.
</p>

<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  I know because I&#ve spent the last seven years helping business owners like you transform their marketing from a money pit into a profit machine. And I&#ve discovered something most marketing agencies don&#t want you to know:
</p>

<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  <strong>Getting leads isn&#t the problem. Converting them into revenue is where most businesses fail.</strong>
</p>
...
<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  <strong>Here&#s How We Do It:</strong>
</p>
...
<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  <strong>But Don’t Just Take My Word For It...</strong>
</p>

<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  Remember that struggling clinic I mentioned? Before working with us, they were giving less than 1,900 treatments a year. Within 12 months of implementing our system, they had given almost 9,000 and were able to increase their prices 60%. That&#s not just growth — that&#s transformation.
</p>
...
<ul className="list-disc pl-6 text-lg leading-relaxed text-dark dark:text-light mb-6">
  <li>&quotI&#ve tried marketing agencies before...&quot</li>
  <li>&quotI&#ve wasted money on ads that didn&#t work...&quot</li>
  <li>&quotI don&#t have time to manage another vendor...&quot</li>
</ul>

<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  I get it. That&#s exactly why we handle everything for you.
</p>

<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  <strong>Here&#s What Happens When You Partner With Us:</strong>
</p>

<ol className="list-decimal pl-6 text-lg leading-relaxed text-dark dark:text-light mb-6">
  <li>We analyze your current marketing and identify revenue opportunities you&#re missing</li>
...
<p className="mb-6 text-lg leading-relaxed text-dark dark:text-light">
  ...
  Click below to schedule your free marketing review. We&#ll analyze your current situation, identify hidden opportunities, and show you exactly how we can help transform your business.
</p>
